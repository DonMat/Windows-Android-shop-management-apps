...
public class Szukaj extends Fragment implements OnItemSelectedListener, OnValueChangeListener{
	  ListView lista;
    ...
    public boolean onContextItemSelected(MenuItem item) {
      ...
      public void show(int poz)
      {
    	  ...
    	  //Toast.makeText(getActivity(), a.getNazwa()+" "+a.getIlosc(), Toast.LENGTH_SHORT).show();
    	  
           final Dialog d = new Dialog(getActivity());
           d.setTitle(getActivity().getResources().getString(R.string.podaj_liczb_sztuk));
           d.setContentView(R.layout.picker_dialog);
           b1 = (Button) d.findViewById(R.id.kup);
           Button b2 = (Button) d.findViewById(R.id.Anuluj);
           final NumberPicker np = (NumberPicker) d.findViewById(R.id.numberPickerIlosc);
           ...
           b1.setOnClickListener(new OnClickListener()
           {
            ...
            public void onClick(View v) {
            	...
            	SetZamowienie t = new SetZamowienie(userID, ilosc, a.getId(), getActivity());
            	a.setIlosc(ilosc);
            	adapterProdukt.notifyDataSetChanged();
            	t.execute();
            	
                d.dismiss();
              Toast.makeText(getActivity(), "Zamowiono: "+np.getValue(), Toast.LENGTH_SHORT).show();
             }    
            });
           b2.setOnClickListener(new OnClickListener()
           {
            @Override
            public void onClick(View v) {
            	Toast.makeText(getActivity(), getActivity().getResources().getString(R.string.anulowano), Toast.LENGTH_SHORT).show();
                d.dismiss();
             }    
            });
         d.show();
    	  ...
    	  {
    		  Toast.makeText(getActivity(), getActivity().getResources().getString(R.string.zaloguj_si_aby_z_o_y_zam_wienie), Toast.LENGTH_SHORT).show();
    	  }
      }
      @Override
